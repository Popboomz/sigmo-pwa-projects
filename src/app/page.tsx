      ...
      <main className="max-w-4xl mx-auto px-6 pt-40 pb-24 relative z-10">
        ...
        <div className="mb-16 text-center animate-enter">
          <div className="relative inline-block mb-8">
            <div className="w-32 h-32 rounded-full brand-orb flex items-center justify-center">
        ...
        <div className="space-y-6">
          ...
          <div className="premium-card y2k-panel p-8 animate-enter" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-start gap-5">
              <div className="w-12 h-12 rounded-2xl brand-tile flex items-center justify-center flex-shrink-0">
                <span className="text-2xl text-[var(--y2k-blue)] font-display font-bold">Σ</span>
              </div>
              <div>
          ...
          <div className="premium-card p-8 animate-enter" style={{ animationDelay: '0.5s' }}>
            ...
            <p className="text-[17px] leading-relaxed text-[var(--y2k-blue)] font-semibold">
          ...
          <div className="premium-card p-8 animate-enter" style={{ animationDelay: '0.6s' }}>
            <div className="flex items-center gap-4 mb-4">
              <div className="w-11 h-11 rounded-2xl brand-tile flex items-center justify-center">
